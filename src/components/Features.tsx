import {
  Search, BookOpen, Tags, Radar, GitFork, Shield,
} from 'lucide-react';
...
function FeatureCard({ icon: Icon, title, description, preview, span, delay = 0 }: FeatureCardProps) {
  return (
    <motion.div
      ...
      className={`glass-panel rounded-[14px] p-7 flex flex-col group hover:border-primary/25 hover:shadow-[var(--shadow-glow)] transition-all duration-300 ${
        span === 'full' ? 'md:col-span-3' : span === 'wide' ? 'md:col-span-2' : ''
      }`}
    >
